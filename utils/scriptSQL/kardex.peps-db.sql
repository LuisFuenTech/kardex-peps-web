CREATE TABLE `detalle` (
  ...
  `nombre_detalle` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `kardex` (
  ...
  `entrada_unitario` decimal(30,2) DEFAULT NULL,
  `entrada_total` decimal(30,2) DEFAULT NULL,
  `salida_cantidad` int(11) DEFAULT NULL,
  `salida_unitario` decimal(30,2) DEFAULT NULL,
  `salida_total` decimal(30,2) DEFAULT NULL,
  `id_detalle` int(11) DEFAULT NULL,
  `id_producto` int(11) DEFAULT NULL,
  `producto_cantidad` int(11) DEFAULT NULL,
  `producto_unitario` decimal(30,2) DEFAULT NULL,
  `producto_total` decimal(30,2) DEFAULT NULL
...
CREATE TABLE `producto` (
  `id_producto` int(11) NOT NULL,
  `nombre_producto` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `cantidad_producto` int(11) NOT NULL,
  `costo_unitario_producto` decimal(30,2) NOT NULL,
  `costo_total_producto` decimal(30,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
